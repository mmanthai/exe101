                    ...
                    <tbody class="bg-white">
                        <tr v-for="member in filterArr" :key="member.id">
                            ...
                            <td class="px-6 py-5 border-b border-gray-200 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink object-contain">
                                        <img class="rounded-2xl mr-3 w-8 h-8" :src="member.ImageUrl" />
                                    </div>
                                    <div class="ml-4 text-[#334D6E]">{{ member.Name }}</div>
                                </div>
                            </td>
                            <td class="px-2 py-4 border-b border-gray-200 whitespace-nowrap">
                                <div class="flex items-center">
                            ...
                            <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                                <div class="flex items-center">
                                    <span v-if="member.ApproveStatusId === 3" class="font-semibold text-[#50D222]">Đã
                                        duyệt</span>

                                    <span v-else-if="member.ApproveStatusId === 4"
                                        class="font-semibold text-[#FF8494]">Đã Từ Chối</span>
                                </div>
                            </td>
                            <td class="px-2 py-4 border-b border-gray-200 whitespace-nowrap">
                                <div class="flex items-center">
...
export default {
    ...
    methods: {
        ...
        getListVendor() {
            this.loading = true;
            VendorService.getListVendor(this.param)
                .then(res => {
                    if (res.data) {
                        let data = res.data;
