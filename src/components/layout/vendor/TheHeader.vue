      ...
      <div class="mr-5 flex float-right relative">
        ...
        <transition name="fade">
          ...
          >
            ...
            <ul
              class="py-3 text-sm text-gray-700 dark:text-gray-200 bg-red-50 mb-1"
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <p class="text-sm">
                      <span class="font-semibold">Sân 2</span>
                      <span class="font-semibold">, Ca 1</span> đã được đặt bởi
                      <span class="font-semibold">phuchlh</span> vào lúc
                      <span class="font-semibold">19h30</span> ngày
                      <span class="font-semibold">26/12/2022</span>
                    </p>
                  </span>
                </span>
              </li>
            ...
            >
              <li>
                <span
                  @click="routerLink('/vendor-profile')"
                  class="py-2 px-4 0 hover:bg-blue-300 hover:text-white cursor-pointer flex items-start justify-start relative pl-11"
                >
                  <span>
                    <Icon
                  ...
                  >
                    ...
                    <p class="text-sm">
                      ...
                      <span class="font-semibold">phuchlh</span> vào lúc
                      <span class="font-semibold">19h30</span> ngày
                      <span class="font-semibold">12/12/2022</span>
                    </p>
                  </span>
                </span>
              </li>
                ...
                >
                  ...
                  >
                    ...
                    <p class="text-sm text-green-500">
                      <span class="font-semibold">Sân 2</span>
                      <span class="font-semibold">, Ca 1</span> đã được đặt bởi
                      <span class="font-semibold">taitt</span> vào lúc
                      <span class="font-semibold">19h30</span> ngày
                      <span class="font-semibold">12/12/2022</span>
                    </p>
                  </span>
        ...
        <button @click="menuToggle" @blur="menuToggleBlur">
          ...
          >
            <img
              ...
              class="rounded-full mr-4 w-10 h-10 object-cover p-1 ring-1 ring-gray-300 dark:ring-gray-500"
              alt=""
            />
          ...
          >
            ...
            >
              <li>
                <span
                  @click="routerLink('/vendor-profile')"
                  class="block py-2 px-4 0 hover:bg-blue-300 hover:text-white cursor-pointer"
            ...
            <div class="py-1">
              <span
                ...
                class="block py-2 px-4 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-300 hover:text-white cursor-pointer"
                >Đăng xuất</span
              >
            </div>
          </div>
