  ...
  <div class="dashboard p-8">
    ...
    >
      ...
      >
        <div class="p-2 max-w-sm">
          <div
            class="bg-green-200 rounded-full w-14 h-14 text-lg p-3 text-green-400 mx-auto"
          >
            <span class="">
              <svg
      ...
      >
        <div class="p-2 max-w-sm">
          <div
            class="bg-red-200 rounded-full w-14 h-14 text-lg p-3 text-yellow-600 mx-auto"
          >
            <span class="">
              <svg
  ...
  data() {
    return {
      ...
      tableBooking: [
        ...
        {
          img: "@/assets/img/Leonardo-Dicaprio-Cheers.jpg",
