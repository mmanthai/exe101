...
import DetailBookingModal from "@/components/layout/vendor/Booking/DetailBookingModal.vue";
...
export default {
  ...
  mounted() {
    ...
    this.param.vendorId = this.userProfile.VendorId;

    UserService.getOwnerProfile(this.userProfile.UserId).then((res) => {
