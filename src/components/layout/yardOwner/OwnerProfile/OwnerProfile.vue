      ...
      <div class="flex">
        ...
        <div>
          <div class="
              ...
              sm:w-20
            ">
            <img @load="closeWaiting" class="h-64  rounded mr-3 lg:w-60 object-contain md:w-40"
              :src="currentUser.Avatar ? currentUser.Avatar : 'https://i.pinimg.com/736x/89/90/48/899048ab0cc455154006fdb9676964b3.jpg'" />
